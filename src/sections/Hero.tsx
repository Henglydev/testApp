...
function Hero() {
  return (
    <section className="md:h[85vh] relative mt-4 flex h-fit max-w-7xl flex-col items-center gap-10 px-8 sm:gap-16 md:my-0 md:flex-row md:gap-0 lg:px-12 xl:m-auto xl:overflow-hidden">
      <div className="sm:w-full md:w-3/6">
        ...
        <p className="m-auto w-[34ch] text-center text-gray-500 md:m-0 md:text-left">
          Take Control of your Finances Anytimes, Anywhere with Kobodrop.
